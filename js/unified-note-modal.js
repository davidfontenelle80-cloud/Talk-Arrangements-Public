  ...
  function ensureModal(){
    ...
    modal.innerHTML = '<div class="unified-note-modal" role="dialog" aria-modal="true" aria-labelledby="unifiedNoteTitle">'+
      ...
      '<div class="unified-note-scroll" id="unifiedNoteScopes">'+
        '<section class="unified-note-scope" data-note-scope="global"><h4><span id="globalNoteLabel"></span><small id="globalNoteHint"></small></h4><div class="note-callout note-callout--blue" id="globalNoteDesc"></div><input id="globalNoteTitle" autocomplete="off"><textarea id="globalNoteDetails" aria-label="Note text"></textarea></section>'+
        '<section class="unified-note-scope" data-note-scope="congregation"><h4><span id="congNoteLabel"></span><small id="congNoteHint"></small></h4><div class="note-callout note-callout--green" id="congNoteDesc"></div><input id="congNoteTitle" autocomplete="off"><textarea id="congNoteDetails" aria-label="Congregation note"></textarea></section>'+
        '<section class="unified-note-scope" data-note-scope="month"><h4><span id="monthNoteLabel"></span><small id="monthNoteHint"></small></h4><div class="note-callout note-callout--amber" id="monthNoteDesc"></div><input id="monthNoteTitle" autocomplete="off"><textarea id="monthNoteDetails" aria-label="Month note"></textarea></section>'+
      '</div>'+ 
