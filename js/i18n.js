...
(function () {
  ...
  // Global safety net: app.js renderReminders calls sanitizeInlineArg() from inline
  // onclick builders. app.js also defines this — this is a belt-and-suspenders fallback.
